...
InputManager::InputManager() :
	_lastCursorPosition(CURSOR_POS), _leftClickPressed(false), _rightClickPressed(false), _movementsInARow(NUM_MOVEMENT_TYPES)
{
...
void InputManager::mouseCursorEvent(GLFWwindow* window, double xpos, double ypos)
{
	...
	if (inputManager->checkPanTilt(xpos, ypos)) paintGL = true;
