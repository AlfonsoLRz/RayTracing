...
//
//const std::unordered_map<uint8_t, int> InputManager::NUM_REPAINTS
//{
//	{ InputManager::EventType::KEY_PRESS, 1 },
//	{ InputManager::EventType::KEY_RELEASE, 1 },
//	{ InputManager::EventType::MOUSE_BUTTON, 2 },
//	{ InputManager::EventType::MOUSE_CURSOR, 1 },
//	{ InputManager::EventType::MOUSE_SCROLL, 1 },
//	{ InputManager::EventType::RESIZE, 2 }
//};
//
///// [Protected methods]
//
...
//	_movementsInARow(NUM_MOVEMENT_TYPES)
//{
//	RenderingParameters* parameters = Renderer::getInstance()->getRenderingParameters();
//
//	_lockCamera = &parameters->_lockCamera;
//}
//
...
//	LiDARScene* currentScene = renderer->getCurrentScene();
//	Group3D* group = currentScene->getRenderingGroup();
//	InputManager* inputManager = InputManager::getInstance();
//
//	if (!*inputManager->_lockCamera)
//	{
//		switch (key)
//		{
...
//			renderer->getScreenshot("Screenshot.png");
//
//			break;
//		case InputManager::ITERATE_LIDAR:
//			currentScene->continueLiDARSimulation();
//
//			break;
//		default:
//			repaint = false;
...
//	}
//
//	inputManager->addRepaints(EventType::KEY_PRESS);
//
//	return repaint;
//}
//
...
//	}
//
//	inputManager->addRepaints(EventType::KEY_RELEASE);
//
//	return true;
//}
//
...
//	}
//	else if (!*inputManager->_lockCamera)
//	{
...
//	InputManager* inputManager = InputManager::getInstance();
//
//	if (*inputManager->_lockCamera) return;
//
...
//	}
//
//	inputManager->addRepaints(EventType::MOUSE_BUTTON);
//}
//
...
//	bool paintGL = false;
//
//	if (!*inputManager->_lockCamera && inputManager->checkPanTilt(xpos, ypos)) paintGL = true;
//
//	if (paintGL)
//	{
//		windowRefresh(window);
//	}
//
//	inputManager->addRepaints(EventType::MOUSE_CURSOR);
//}
//
...
//	}
//
//	inputManager->addRepaints(EventType::MOUSE_SCROLL);
//}
//
...
//
//	inputManager->addRepaints(EventType::RESIZE);
//}
//
...
//}
//
//void InputManager::addRepaints(InputManager::EventType event)
//{
//	_leftRepaints += NUM_REPAINTS.at(event);
//}
