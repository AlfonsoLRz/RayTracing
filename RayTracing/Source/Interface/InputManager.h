...
//	// [Amount constraints]
//
//	static const std::unordered_map<uint8_t, int> NUM_REPAINTS;				//!< Number of rendering calls for most events (related to ImGui)
//
//protected:
...
//	bool*					_lockCamera;									//!< Is camera movement allowed?
...
//
//	/**
//	*	@brief Adds more repaints calls. The number of calls depends on the event type.
//	*/
//	void addRepaints(EventType event);
//
//	/**
//	*	@brief Reduces the number of repaints by one.
//	*/
//	void decrementRepaints() { _leftRepaints -= 1; }
//
//	/**
//	*	@return Number of rendering calls which are still pending.
//	*/
//	int getRepaints() { return _leftRepaints; }
//};
