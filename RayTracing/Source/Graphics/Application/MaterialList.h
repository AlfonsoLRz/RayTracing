...
#include "Graphics/Application/CGApplicationEnumerations.h"
...
protected:
	...
	*/
	void createMaterial(const CGApplicationEnumerations::MaterialNames material);
...
public:
	...
	*/
	Material* getMaterial(const CGApplicationEnumerations::MaterialNames material);
};
