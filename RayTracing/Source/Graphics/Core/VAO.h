...
protected:
	...
	*/
	void declareSimpleVBO(const CGEnumerations::VBOTypes vboType, const GLsizei dataSize, const GLuint unitType, int& shaderSlot);
	...
	*	@param shaderSlot Input channel of VBO.
	*/
	void declareInterleavedVBO(const CGEnumerations::VBOTypes vboType, const GLsizei totalSize, const std::vector<unsigned long long>& dataSize, const std::vector<GLuint>& unitType, int& shaderSlot);
...
public:
	...
	*/
	void drawObject(const CGEnumerations::IBOTypes iboType, const GLuint openGLPrimitive, const GLuint numIndices);
	...
	*/
	void drawObject(const CGEnumerations::IBOTypes iboType, const GLuint openGLPrimitive, const GLuint numIndices, const GLuint numObjects);
	...
	*/
	template<typename T>
	void setVBOData(const CGEnumerations::VBOTypes vboType, const std::vector<T>& geometryData, const GLuint changeFrequency = GL_STATIC_DRAW);
	...
	*/
	template<typename T>
	void setVBOData(const CGEnumerations::VBOTypes vboType, T* geometryData, const GLuint size, const GLuint changeFrequency = GL_STATIC_DRAW);
	...
	*/
	void setIBOData(const CGEnumerations::IBOTypes iboType, const std::vector<GLuint>& topologyData, const GLuint changeFrequency = GL_STATIC_DRAW);
};

template<typename T>
void VAO::setVBOData(const CGEnumerations::VBOTypes vboType, const std::vector<T>& geometryData, const GLuint changeFrequency)
{
...
template<typename T>
void VAO::setVBOData(const CGEnumerations::VBOTypes vboType, T* geometryData, const GLuint size, const GLuint changeFrequency)
{
	glBindVertexArray(_vao);
