...
protected:
	...
	*/
	void declareSimpleVBO(const CGEnumerations::VBOTypes vboType, const GLsizei dataSize, const GLuint unitType, const int shaderSlot);
	...
	*	@param shaderSlot Input channel of VBO.
	*/
	void declareInterleavedVBO(const CGEnumerations::VBOTypes vboType, const GLsizei totalSize, const std::vector<unsigned long long>& dataSize, const std::vector<GLuint>& unitType);
