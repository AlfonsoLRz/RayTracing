...
Texture::Texture(UnsignedImage* image, const GLuint wrapS, const GLuint wrapT, const GLuint minFilter, const GLuint magFilter)
	: _id(-1)
{
	this->loadImage(image, minFilter, magFilter, wrapS, wrapT);
}

Texture::Texture(float* image, const int width, const int height, const bool isRGBA, const GLuint wrapS, const GLuint wrapT, const GLuint minFilter, const GLuint magFilter)
	: _id(-1)
{
	glGenTextures(1, &_id);
...
Texture::Texture(std::vector<UnsignedImage*> images, const int width, const int height, const GLuint wrapS, const GLuint wrapT, const GLuint wrapR, const GLuint minFilter, const GLuint magFilter)
	: _id(-1)
{
	glGenTextures(1, &_id);
...
bool Texture::loadImage(UnsignedImage* image, const GLuint minFilter, const GLuint magFilter, const GLuint wrapS, const GLuint wrapT)
{
