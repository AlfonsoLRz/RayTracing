...
void VAO::defineIntensityVBO()
{
	...
	glBindVertexArray(_vao);
	this->declareSimpleVBO(RendEnum::VBO_INTENSITY, sizeof(GLfloat), GL_FLOAT, vboIndex);
}
...
void VAO::defineReturnNumberVBO()
{
	...
	glBindVertexArray(_vao);
	this->declareSimpleVBO(RendEnum::VBO_RETURN_NUMBER, sizeof(GLfloat), GL_FLOAT, vboIndex);
}
...
void VAO::defineReturnPercentageVBO()
{
	...
	glBindVertexArray(_vao);
	this->declareSimpleVBO(RendEnum::VBO_RETURN_DIVISION, sizeof(GLfloat), GL_FLOAT, vboIndex);
}
