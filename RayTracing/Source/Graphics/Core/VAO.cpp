...
//	{
//		_vboIndex = 0;
//		this->declareSimpleVBO(CGEnumerations::VBO_POSITION, sizeof(vec4), GL_FLOAT, _vboIndex);
//		this->declareSimpleVBO(CGEnumerations::VBO_NORMAL, sizeof(vec3), GL_FLOAT, _vboIndex);
//		this->declareSimpleVBO(CGEnumerations::VBO_TEXT_COORD, sizeof(vec2), GL_FLOAT, _vboIndex);
//		this->declareSimpleVBO(CGEnumerations::VBO_TANGENT, sizeof(vec3), GL_FLOAT, _vboIndex);
//	}
//	else
//	{
...
///// [Protected methods]
//
//void VAO::declareSimpleVBO(const CGEnumerations::VBOTypes vboType, const GLsizei dataSize, const GLuint unitType, int& shaderSlot)
//{
...
//}
//
//void VAO::declareInterleavedVBO(const CGEnumerations::VBOTypes vboType, const GLsizei totalSize, const std::vector<unsigned long long>& dataSize, const std::vector<GLuint>& unitType, int& shaderSlot)
//{
//	// VAO is considered to be binded at this point
//
//	GLuint vbo = 0;
